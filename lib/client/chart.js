...
function init (client, d3, $) {
  ...
  chart.createBrushedRange = function() {
    ...
    // Position current time at ~85% from left (show 85% history, 15% future/buffer)
    range[0] = new Date(end - client.focusRangeMS * 0.85);
    range[1] = new Date(end + client.focusRangeMS * 0.15);

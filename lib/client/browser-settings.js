...
function init (client, serverSettings, $) {
  ...
  function loadForm () {
    ...
    if (token != '') {
      ...
      $('#homelink').attr('href', '/' + token);
      $('#closeButton').attr('href', '/' + token);
      $('#bgclocklink').attr('href', '/clock/bgclock' + token);
      $('#clockcolorlink').attr('href', '/clock/clock-color' + token);
      $('#clocklink').attr('href', '/clock/clock' + token);
    }
  }
